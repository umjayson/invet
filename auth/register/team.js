...
export default function TeamRegistration() {
  ...
  const { createTeamAccount } = useAuth()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await createTeamAccount(email, password, teamName, teamDetails)
      setTeamPin(result.teamPin)
      setSuccess(true)
    } catch (error) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-xl overflow-hidden">
          ...
          <div className="p-6 text-center border-b border-white/10">
            ...
            <p className="text-purple-200 mt-2">Create a team account for InvetChat</p>
          </div>
          ...
          <div className="p-6">
            ...
            {success ? (
              <div className="bg-green-500/20 text-white border border-green-500/30 rounded-md p-4 text-center">
                ...
                <p className="mb-4">Your team account has been created. Here's your team PIN:</p>

                <div className="bg-indigo-900/50 p-4 rounded-lg mb-4 inline-block">
                  <span className="text-2xl font-mono font-bold tracking-wider">{teamPin}</span>
                </div>

                <p className="mb-4 text-purple-200">
                  <strong className="text-white">Important:</strong> Share this PIN with your team members so they can
                  join your team. Keep it secure!
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="form-group">
                  <label htmlFor="teamName" className="form-label text-white">
                    Team Name
                  </label>
                ...
                <div className="form-group">
                  <label htmlFor="teamSize" className="form-label text-white">
                    Team Size
                  </label>
                  <select
                    id="teamSize"
                    className="form-input bg-white/10 border-purple-500/30 text-white focus:border-purple-400 transition-all pl-10"
                    value={teamSize}
                ...
                <div className="form-group">
                  <label htmlFor="teamDescription" className="form-label text-white">
                    Team Description
                  </label>
                  <div className="relative">
                    <textarea
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="absolute left-3 top-6 h-4 w-4 text-purple-300"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
