      ...
      <div className="w-full max-w-md">
        <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-xl overflow-hidden">
          ...
          <div className="p-6 text-center border-b border-white/10">
            ...
            <p className="text-purple-200 mt-2">Create an admin account for InvetChat</p>
          </div>
          ...
          <div className="p-6">
            ...
            {success ? (
              <div className="bg-green-500/20 text-white border border-green-500/30 rounded-md p-4 text-center">
                ...
                <p className="mb-4">Your admin account has been created successfully.</p>
                <Link
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="form-group">
                  <label htmlFor="adminPin" className="form-label text-white">
                    Admin PIN
                  </label>
                  <div className="relative">
                    <input
                  ...
                  <p className="text-xs text-purple-300 mt-1">
                    Contact system administrator if you don't have an admin PIN
                  </p>
                </div>
